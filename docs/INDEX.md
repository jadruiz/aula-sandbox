# Mapa documental — aula-sandbox

## TL;DR

Lee primero el Quickstart; después diagramas y frontera de Kasai Crew; por último ADR y
evidencia. Aula sólo empaqueta y arranca herramientas.
...
| [`asilo/README.md`](asilo/README.md) | Controles ASILO adoptados y límites |
| [`../governance/decisions/ADR-001-alcance-y-frontera.md`](../governance/decisions/ADR-001-alcance-y-frontera.md) | Por qué es un repo aparte de asilo-sandbox y qué NO promete |
| [`architecture/kasai-crew-runtime.md`](architecture/kasai-crew-runtime.md) | Cómo recibe bundles sin montar los repos de origen |
| [`../governance/decisions/ADR-002-kasai-crew-runtime.md`](../governance/decisions/ADR-002-kasai-crew-runtime.md) | Por qué hay una crew de ecosistema y no una por repo |
